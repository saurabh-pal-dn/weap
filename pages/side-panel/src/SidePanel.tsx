...
const SidePanel = () => {
  ...
  return (
    <div>
      <div
        className={`flex h-screen flex-col ${isDarkMode ? 'bg-black' : "bg-[url('/bg.jpg')] bg-cover bg-no-repeat"} overflow-hidden border ${isDarkMode ? 'border-sky-800' : 'border-[rgb(186,230,253)]'} rounded-2xl`}>
        <header className="header relative">
          <div className="header-logo">
            {showHistory ? (
              ...
              <>
                <img src="/icon-128.png" alt="Extension Logo" className="size-8" />
                <p className={`mb-2 pl-2 pt-2 text-lg font-semibold ${isDarkMode ? 'text-sky-500' : 'text-sky-700'}`}>
            ...
            {hasConfiguredModels === false && (
              <div
                ...
                <div className="max-w-md text-center">
                  <img src="/icon-128.png" alt="icon" className="mx-auto mb-4 size-12" />
                  ...
                  <div className="mt-4 text-sm opacity-75">
                    <a
                      // TODO: changes
                      href="https://en.wikipedia.org/wiki/Agentic_AI"
                      target="_blank"
